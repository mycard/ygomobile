...
import cn.garymb.ygomobile.loader.AbstractImageItemController;
import cn.garymb.ygomobile.loader.BitmapHolder;
import cn.garymb.ygomobile.loader.ImageFileDownloadTaskHolder;
import cn.garymb.ygomobile.loader.CardImageItemController;
...
public class CardAdapter extends CursorAdapter implements IDataObserver, OnScrollListener {
	...
	private void requestImage(ImageItem item, boolean isPreload) {
		...
		// Controller.get().requestDataOperation(this, msg);
		// }
	}
