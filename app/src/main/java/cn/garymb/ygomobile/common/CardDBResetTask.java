...
public class CardDBResetTask extends AsyncTask<Void, Void, Boolean> {
	...
	protected Boolean doInBackground(Void... params) {
		String dataBasePath = StaticApplication.get().getDataBasePath();
		Boolean result = DatabaseUtils.checkAndCopyFromInternalDatabase(StaticApplication.get(), dataBasePath, true);
		return result;
	}
