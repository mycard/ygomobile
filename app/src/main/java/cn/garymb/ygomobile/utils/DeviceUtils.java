...
public class DeviceUtils {
	...
	public static float getScreenWidth() {
		return StaticApplication.get().getScreenWidth();
	}
	
	public static float getSmallerSize() {
		return StaticApplication.get().getSmallerSize();
	}
	
	public static float getScreenHeight() {
		return StaticApplication.get().getScreenHeight();
	}

	public static float getDensity() {
		return StaticApplication.get().getDensity();
	}
	
	public static float getXScale() {
		return StaticApplication.get().getXScale();
	}
	
	public static float getYScale() {
		return StaticApplication.get().getYScale();
	}
	...
	public static boolean testUpdateVersion(String url) {
		Context context = StaticApplication.get();
